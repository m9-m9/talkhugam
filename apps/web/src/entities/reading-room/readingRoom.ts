...
/** 책방 메시지 미리보기 값을 화면 표시용 문자열로 변환한다. */
...
/** 원본 데이터를 멤버 정보를 포함한 책방 목록 도메인 모델로 변환한다. */
...
/** 원본 데이터를 책방 최근 메시지 도메인 모델로 변환한다. */
