    ...
    sections: [
      {
        ...
        body: [
          ...
          '서비스 개선을 위해 Google Analytics 4와 Microsoft Clarity를 사용하며, 기기·브라우저 정보와 접속·이용 흐름 등 최소한의 이용 정보를 처리합니다. 분석 이벤트에는 이메일, 사용자 ID, 표시 이름, 독서방·책 제목, 대화 본문, 영상 URL·파일명, 초대 코드를 넣지 않습니다. Clarity에는 서비스 화면의 텍스트와 이용자 콘텐츠를 명시적으로 마스킹한 상태로 화면 구조와 상호작용 정보만 전송합니다.',
