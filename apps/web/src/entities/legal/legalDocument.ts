export const legalDocumentVersion = '2026-07-18.1' as const
    ...
    sections: [
      {
        heading: '1. 서비스의 목적',
        body: [
          'Talk후감은 가까운 사람들과 비공개 독서방에서 책을 읽고, 대화와 짧은 영상 기록을 나누는 서비스입니다.',
      ...
      },
      {
        ...
        body: [
          ...
          '독서방은 초대 코드로 참여하는 비공개 공간입니다. 방장과 참여자는 초대 코드를 제3자에게 공유하지 않도록 주의해야 합니다.',
        ],
      },
      {
        heading: '3. 대화와 영상 기록',
        body: [
          ...
          '영상 기록은 해당 독서방의 참여자가 보는 용도로만 이용해야 하며, 서비스 밖으로 재배포해서는 안 됩니다.',
        ],
      },
      {
    ...
    sections: [
      {
        ...
        body: [
          ...
          '프로필, 독서방 참여 정보, 책 대화·댓글·멘션, 완독 기록, 영상 기록은 독서방 기능 제공과 이용자 간 소통을 위해 처리합니다.',
          '전역 의견 보내기로 접수한 유형과 본문, 작성자 프로필, 로그인 이메일은 서비스 개선과 필요한 경우 이메일 회신을 위해 처리합니다.',
          '서비스 개선을 위해 Google Analytics 4를 사용하며, 기기·브라우저 정보와 접속·이용 흐름 등 최소한의 이용 정보를 처리합니다. 분석 이벤트에는 이메일, 사용자 ID, 표시 이름, 독서방·책 제목, 대화 본문, 영상 URL·파일명, 초대 코드를 넣지 않습니다.',
      ...
      },
      {
        heading: '2. 보관과 삭제',
        body: [
          '계정과 독서방 기록은 서비스를 이용하는 동안 보관합니다.',
          '계정 삭제를 요청하면 계정과 연결된 프로필, 독서방 참여 정보, 게시물 및 영상 기록을 서비스의 삭제 절차에 따라 정리합니다. 법령상 보관 의무가 있는 정보는 해당 기간 동안 별도로 보관할 수 있습니다.',
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          'Google Analytics 4의 분석 쿠키와 기기 정보 처리는 브라우저 설정에서 제한하거나 삭제할 수 있습니다. 이 경우 일부 분석 정보가 수집되지 않을 수 있습니다.',
