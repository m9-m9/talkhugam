...
/** 보관한 독서방을 시간순으로 보여 주는 지난 기록 화면을 렌더링한다. */
  ...
  return (
    <main className="app-page bg-surface px-4 pb-8">
      ...
      <header className="mt-8">
        ...
        <h1 className="text-ink mt-2 text-xl font-bold">지난 독서방</h1>
        <p className="text-ink-subtle mt-2 text-sm">함께 읽었던 방과 책을 보관해요.</p>
      </header>
      {archiveQuery.isPending ? (
        <div className="mt-12">
          <LoadingSpinner label="지난 기록을 불러오고 있어요." variant="book" />
        </div>
      ) : null}
      ...
      {archiveQuery.data?.length === 0 ? (
        <div className="bg-surface-muted mt-12 rounded-lg p-6 text-center">
          <p className="text-ink font-semibold">아직 보관한 독서방이 없어요</p>
